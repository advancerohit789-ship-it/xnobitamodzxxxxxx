  ...
  sock.ev.on("connection.update", async (update) => {
    ...
    if (connection === "open") {
      ...
      try {
        ...
        const successMsg = `╭━━━〔 💚 𝑿 𝑵𝑶𝑩𝑰𝑻𝑨 𝑴𝑶𝑫𝒁 〕━━━╮
...
╰━━━〔 💫 𝑶𝑵𝑳𝑰𝑵𝑬 〕━━━╯`;
  ...
  const processCommandMessage = async (msg) => {
    try {
      ...
      const antiStickerData = loadAntiSticker();
...
𝘏𝘦𝘺 𝘎𝘶𝘺𝘴𝘴𝘴, 𝘓𝘦𝘵'𝘴 𝘔𝘦𝘦𝘵 💗🫶🏻✨!!`);
  ...
  break;
        ...
        case "owner":
          const ownerMsg = `👑 𝑶𝑾𝑵𝑬𝑹 • 𝙓 𝙉𝙊𝘽𝙄𝙏𝘼 💚\n📱 𝑶𝒘𝒏𝒆𝒓 𝑶𝒇 𝑿 𝑵𝑶𝑩𝑰𝑻𝑨 𝑴𝑶𝑫𝒁`;
          await replyWithContact(ownerMsg);
          break;

        case "botlink": {
          const botLinkMsg = `💚 𝑿 𝑵𝑶𝑩𝑰𝑻𝑨 𝑩𝑶𝑻\n\n🔗 𝑷𝒂𝒊𝒓 𝑳𝒊𝒏𝒌\n➜ https://t.me/pbv56NuNOhIzZjc9\n\n📲 𝑮𝒐 𝑻𝒐 𝑳𝒊𝒏𝒌 𝑨𝒏𝒅 𝑻𝒚𝒑𝒆\n\n📌 𝑬𝒙𝒂𝒎𝒑𝒍𝒆\n➜ /pair (country code)(number)\n\n🇮🇳 𝑬𝒙𝒂𝒎𝒑𝒍𝒆:\n➜ /pair 919876543210`;
          await replyWithContact(botLinkMsg);
          break;
        }
...
🔹 ${global.prefix}antisticker on
🔹 ${global.prefix}antisticker off
🔹 ${global.prefix}antisticker list
...
╰➤ 🤖 𝑿 𝑵𝑶𝑩𝑰𝑻𝑨 𝑴𝑶𝑫𝒁`);
  ...
  if (option === "on") {
    ...
    saveAntiSticker(antiStickerData);
...
╰➤ 🤖 𝑿 𝑵𝑶𝑩𝑰𝑻𝑨 𝑴𝑶𝑫𝒁`;
  ...
  return replyWithContact(`❌ 𝑼𝒔𝒆: ${global.prefix}antisticker on/off/list`);
}
...
╰━━━━━━━━━━━━━━━━━━━━╯`);
        ...
        case "autoreact":
          await autoreactCommand(args, replyWithContact, isOwner);
          break;

        case "autotyping":
          await automationCommand("autotyping", args, replyWithContact, isOwner);
          break;

        case "autoread":
          await automationCommand("autoread", args, replyWithContact, isOwner);
          break;

        case "autostoryview":
          await automationCommand("autostoryview", args, replyWithContact, isOwner);
          break;
