...
case "antilinkmode":
  if (!isGroup) return replyWithContact("❌ 𝙂𝙧𝙤𝙪𝙥 𝙤𝙣𝙡𝙮!");
  if (!isAdmin && !isOwner) return replyWithContact("❌ 𝘼𝙙𝙢𝙞𝙣 𝙤𝙣𝙡𝙮!");
  ...
  if (alMode === "off") {
    ...
    return replyWithContact("🌸 𝘼𝙣𝙩𝙞𝙡𝙞𝙣𝙠 𝙊𝙁𝙁");
  }

  if (!["warn", "delete", "kick"].includes(alMode))
    return replyWithContact("❌ 𝙄𝙣𝙫𝙖𝙡𝙞𝙙 𝙢𝙤𝙙𝙚");

  global.antilinkMode[jid] = alMode;

  if (alMode === "warn")
    return replyWithContact("🌷 𝘼𝙣𝙩𝙞𝙡𝙞𝙣𝙠 𝙒𝙖𝙧𝙣 𝙊𝙉\n⚠️ 𝙇𝙞𝙣𝙠 𝙙𝙚𝙡𝙚𝙩𝙚 + 𝙬𝙖𝙧𝙣");

  if (alMode === "delete")
    return replyWithContact("🧸 𝘼𝙣𝙩𝙞𝙡𝙞𝙣𝙠 𝘿𝙚𝙡𝙚𝙩𝙚 𝙊𝙉");

  if (alMode === "kick")
    return replyWithContact("🐰 𝘼𝙣𝙩𝙞𝙡𝙞𝙣𝙠 𝙆𝙞𝙘𝙠 𝙊𝙉");
  break;
