...
𝘏𝘦𝘺 𝘎𝘶𝘺𝘴𝘴𝘴, 𝘓𝘦𝘵'𝘴 𝘔𝘦𝘦𝘵 💗🫶🏻✨!!`);
        ...
        case "ping": {
          ...
          await reply(`🟢 𝑩𝒐𝒕 𝑰𝒔 𝑶𝒏𝒍𝒊𝒏𝒆 💋  ⚡ 𝑺𝒑𝒆𝒆𝒅 : ${speed.toFixed(2)}ms`);
          break;
        }
...
case "antigroupmention": {
  ...
  if (!["on", "off"].includes(gmMode))
    return reply("💡 𝑼𝒔𝒆: .antigroupmention on / .antigroupmention off");

  if (gmMode === "on") {
    global.antigmMode[jid] = true;
    return reply("🛡️ 𝑨𝑵𝑻𝑰 𝑮𝑹𝑶𝑼𝑷 𝑴𝑬𝑵𝑻𝑰𝑶𝑵 𝑬𝑵𝑨𝑩𝑳𝑬𝑫\n\n👁️ 𝑨𝒄𝒄𝒆𝒔𝒔𝒊𝒃𝒍𝒆 𝒈𝒓𝒐𝒖𝒑-𝒎𝒆𝒏𝒕𝒊𝒐𝒏 𝒔𝒕𝒂𝒕𝒖𝒔 𝒆𝒗𝒆𝒏𝒕𝒔 𝒘𝒊𝒍𝒍 𝒃𝒆 𝒎𝒐𝒏𝒊𝒕𝒐𝒓𝒆𝒅.");
  }

  delete global.antigmMode[jid];
  return reply("🛡️ 𝑨𝑵𝑻𝑰 𝑮𝑹𝑶𝑼𝑷 𝑴𝑬𝑵𝑻𝑰𝑶𝑵 𝑫𝑰𝑺𝑨𝑩𝑳𝑬𝑫");
}
...
╰━━━━━━━━━━━━━━━━━━━━╯`);
        ...
        case "autoreact":
          await autoreactCommand(args, reply, isOwner);
          break;

        case "autotyping":
          await automationCommand("autotyping", args, reply, isOwner);
          break;

        case "autoread":
          await automationCommand("autoread", args, reply, isOwner);
          break;

        case "autostoryview":
          await automationCommand("autostoryview", args, reply, isOwner);
          break;
